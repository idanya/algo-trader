...
def generate_candle_with_symbol(symbol: str, time_span: TimeSpan, timestamp: datetime) -> Candle:
    return Candle(
        symbol=symbol, time_span=time_span, timestamp=timestamp, open=0.0, close=0.0, high=0.0, low=0.0, volume=0.0
    )
...
def generate_candle_with_price_and_symbol(
    symbol: str, time_span: TimeSpan, timestamp: datetime, price: float
) -> Candle:
