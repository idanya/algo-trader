...
class EWrapper:
    ...
    def error(self, reqId:TickerId, errorCode:int, errorString:str):
        ...
        communication or when TWS wants to send a message to the ib_client."""
    ...
    def orderStatus(self, orderId:OrderId , status:str, filled:float,
        ...
        also fired after reconnecting to TWS if the ib_client has any open orders.
        ...
        clientId:int - The ID of the ib_client (or TWS) that placed the order. Note that TWS orders have a fixed clientId and orderId of 0 that distinguishes them from API orders.
    ...
    def execDetailsEnd(self, reqId:int):
        ...
        a ib_client in response to reqExecutions()."""
    ...
    def displayGroupUpdated(self, reqId:int, contractInfo:str):
        """This is sent by TWS to the API ib_client once after receiving
